...
const GuideDisplay: React.FC<GuideDisplayProps> = ({ guide }) => {
  return (
    <div className="space-y-8 animate-fade-in">
      <header className="text-center bg-brand-secondary p-6 rounded-xl shadow-lg">
        <p className="text-brand-accent font-semibold">{guide.vehicle}</p>
        <h2 className="text-3xl md:text-4xl font-extrabold text-white mt-1">{guide.task}</h2>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-brand-secondary p-6 rounded-xl shadow-lg">
          <h3 className="text-xl font-bold text-white flex items-center mb-4">
            <WrenchScrewdriverIcon className="h-6 w-6 mr-3 text-brand-accent" />
        ...
        <div className="bg-brand-secondary p-6 rounded-xl shadow-lg">
          <h3 className="text-xl font-bold text-white flex items-center mb-4">
            <CogIcon className="h-6 w-6 mr-3 text-brand-accent" />
      ...
      <div>
        <h3 className="text-2xl font-bold text-white text-center mb-6">Instruções Passo a Passo</h3>
