  ...
  return (
    <div className="flex flex-col items-center justify-center text-center space-y-4 py-16 animate-fade-in">
       <div className="relative flex justify-center items-center">
        <div className="absolute w-24 h-24 rounded-full animate-spin border-4 border-solid border-brand-accent border-t-transparent"></div>
        <svg className="w-16 h-16 text-brand-accent" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
      ...
      <p className="text-lg font-semibold text-white mt-4">Montando Seu Guia</p>
      <p className="text-brand-text-muted transition-opacity duration-500">{messages[messageIndex]}</p>
    </div>
  );
};
